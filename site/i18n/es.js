...
window.EPHER_I18N["es"] = {
  ...
  "lede": "Un motor de cálculo, cinco formas de usarlo: la línea de comandos, el REPL, la terminal, el escritorio y una aplicación web sin conexión. Habla ocho idiomas y está disponible para Windows, macOS, Linux y en el navegador. Escribe expresiones, guarda funciones y scripts, dibuja los resultados en 2D o 3D y conserva todo entre sesiones. Sin cuenta, sin nube: tu trabajo se queda en tu dispositivo.",
