...
const SECTIONS = [
  {
    ...
    examples: [
      ...
      { cap: "ex-a15", capText: "The solar system at an instant: orbits, trails, and labelled dots. Give the time as a constant and press play to watch the planets move.", kind: "epher", code: `const t = now()\nsolar3d t` },
