...
Every installer ships the whole [script collection](https://epher.org/scripts.html) (347 ready-to-run scripts), installed beside the program. The same script, on each operating system:
