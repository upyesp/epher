...
pub struct Areas {
    ...
    pub kp_bank_labels: [ratatui::layout::Rect; 10],
...
pub fn keypad_hint_key(disp: &str) -> Option<&'static str> {
    ...
    match disp {
        ...
        // date/time readers (ADR-0037 amendment)
        "date" => named("key-hint-date"),
        "time" => named("key-hint-time"),
        "iso" => named("key-hint-iso"),
        // complex numbers and calculus
        "re" => named("key-hint-re"),
        "im" => named("key-hint-im"),
        "arg" => named("key-hint-arg"),
        "conj" => named("key-hint-conj"),
        "derivative" => named("key-hint-derivative"),
        "integral" => named("key-hint-integral"),
        // random
        "randint" => named("key-hint-randint"),
        "random" => named("key-hint-random"),
        "randseed" => named("key-hint-randseed"),
        "randn" => named("key-hint-randn"),
        // lists and matrices
        "[" => named("key-hint-lsqb"),
        "]" => named("key-hint-rsqb"),
        "{" => named("key-hint-lbrace"),
        "}" => named("key-hint-rbrace"),
        "\"" => named("key-hint-quote"),
        "det" => named("key-hint-det"),
        "inv" => named("key-hint-inv"),
        "transpose" => named("key-hint-transpose"),
        "rref" => named("key-hint-rref"),
        "dim" => named("key-hint-dim"),
        "str" => named("key-hint-str"),
        "len" => named("key-hint-len"),
        "upper" => named("key-hint-upper"),
        "lower" => named("key-hint-lower"),
        "trim" => named("key-hint-trim"),
        "substr" => named("key-hint-substr"),
        "split" => named("key-hint-split"),
        "join" => named("key-hint-join"),
        "find" => named("key-hint-find"),
        "replace" => named("key-hint-replace"),
        "fixed" => named("key-hint-fixed"),
        // regression and distributions
        "linreg" => named("key-hint-linreg"),
        "quadreg" => named("key-hint-quadreg"),
        "expreg" => named("key-hint-expreg"),
        "powreg" => named("key-hint-powreg"),
        "logreg" => named("key-hint-logreg"),
        "anova" => named("key-hint-anova"),
        "ttestpaired" => named("key-hint-ttestpaired"),
        "normcdf" => named("key-hint-normcdf"),
        "normpdf" => named("key-hint-normpdf"),
        "invnorm" => named("key-hint-invnorm"),
        "tcdf" => named("key-hint-tcdf"),
        "tpdf" => named("key-hint-tpdf"),
        "invt" => named("key-hint-invt"),
        "ttest" => named("key-hint-ttest"),
        "tinterval" => named("key-hint-tinterval"),
        "ztest" => named("key-hint-ztest"),
        "zinterval" => named("key-hint-zinterval"),
        "binomcdf" => named("key-hint-binomcdf"),
        "binompdf" => named("key-hint-binompdf"),
        "poissoncdf" => named("key-hint-poissoncdf"),
        "poissonpdf" => named("key-hint-poissonpdf"),
        "chi2cdf" => named("key-hint-chi2cdf"),
        "chi2pdf" => named("key-hint-chi2pdf"),
        "invchi2" => named("key-hint-invchi2"),
        // finance
        "tvm_n" => named("key-hint-tvm-n"),
        "tvm_i" => named("key-hint-tvm-i"),
        "tvm_pv" => named("key-hint-tvm-pv"),
        "tvm_pmt" => named("key-hint-tvm-pmt"),
        "tvm_fv" => named("key-hint-tvm-fv"),
        "npv" => named("key-hint-npv"),
        "irr" => named("key-hint-irr"),
        "amort" => named("key-hint-amort"),
        "compound_interest" => named("key-hint-compound-interest"),
        "simple_interest" => named("key-hint-simple-interest"),
        // astronomy accessors that were web-only
        "dms2deg" => named("key-hint-dms2deg"),
        "deg2dms" => named("key-hint-deg2dms"),
        "jy2mag" => named("key-hint-jy2mag"),
        "march_equinox" => named("key-hint-march-equinox"),
        "june_solstice" => named("key-hint-june-solstice"),
        "september_equinox" => named("key-hint-september-equinox"),
        "december_solstice" => named("key-hint-december-solstice"),
        // astronomy constants (counts in natural units)
        ...
        "g" => named("key-hint-g"),
        "h" => named("key-hint-h"),
        "h_bar" => named("key-hint-h-bar"),
        "k_b" => named("key-hint-k-b"),
        "sigma_sb" => named("key-hint-sigma-sb"),
        "m_sun" => named("key-hint-m-sun"),
        "r_sun" => named("key-hint-r-sun"),
        "l_sun" => named("key-hint-l-sun"),
        "m_earth" => named("key-hint-m-earth"),
        "r_earth" => named("key-hint-r-earth"),
        "m_moon" => named("key-hint-m-moon"),
        "r_moon" => named("key-hint-r-moon"),
        // unit suffixes (the dot marks the leading-space insert)
        "AU" => named("key-hint-u-au"),
        "pc\u{b7}" => named("key-hint-u-pc"),
        "ly\u{b7}" => named("key-hint-u-ly"),
        "deg\u{b7}" => named("key-hint-u-deg"),
        "arcmin\u{b7}" => named("key-hint-u-arcmin"),
        "arcsec\u{b7}" => named("key-hint-u-arcsec"),
        "min\u{b7}" => named("key-hint-u-min"),
        "hr\u{b7}" => named("key-hint-u-hr"),
        "d\u{b7}" => named("key-hint-u-d"),
        "yr\u{b7}" => named("key-hint-u-yr"),
        "Jy" => named("key-hint-u-jy"),
        "deg2dms" => named("key-hint-deg2dms"),
...
impl App {
    ...
    pub fn menu_len(&self, menu: usize) -> usize {
        match menu {
            0 => 3, // File: open script, save script, quit (ADR-0027 amendment)
    ...
    pub fn menu_activate(&mut self) -> Option<MenuAction> {
        ...
        let action = match menu {
            0 => match item {
                0 => MenuAction::OpenScript,
                1 => MenuAction::SaveScript,
                _ => MenuAction::Quit,
            },
            1 => match item {
                0 => MenuAction::Cut,
    ...
    pub fn prompt_start(&mut self, kind: PromptKind) {
        let default = match kind {
            PromptKind::SaveScript => "epher-script.epher".to_string(),
            PromptKind::OpenScript => String::new(),
        };
        self.prompt_cursor = default.len();
    ...
    pub fn prompt_push(&mut self, c: char) {
        if let Some((_, buf)) = &mut self.prompt {
            let at = self.prompt_cursor.min(buf.len());
            buf.insert(at, c);
            self.prompt_cursor = at + c.len_utf8();
        }
    }

    pub fn prompt_pop(&mut self) {
        if let Some((_, buf)) = &mut self.prompt {
            let at = self.prompt_cursor;
            if let Some((i, c)) = buf[..at].char_indices().next_back() {
                buf.replace_range(i..at, "");
    ...
    pub fn prompt_submit(&mut self, _localizer: &Localizer) -> Option<PromptKind> {
    ...
    pub fn prompt_restore(&mut self, kind: PromptKind, path: &str) {
        self.prompt_cursor = path.len();
        self.prompt = Some((kind, path.to_string()));
    }

    /// The prompt's caret as a byte offset (0 when no prompt is open).
    ...
    /// Move the prompt's caret one character left/right (byte-aware).
    pub fn prompt_nudge(&mut self, dir: isize) {
        if let Some((_, buf)) = &self.prompt {
            let at = self.prompt_cursor;
            let next = if dir < 0 {
                buf[..at]
                    .char_indices()
    ...
    /// Move the prompt's caret to the start/end of the path.
    pub fn prompt_edge(&mut self, dir: isize) {
        if let Some((_, buf)) = &self.prompt {
            self.prompt_cursor = if dir < 0 { 0 } else { buf.len() };
        }
    }

    /// Delete the character at the prompt's caret (the Delete key).
    pub fn prompt_delete(&mut self) {
        if let Some((_, buf)) = &mut self.prompt {
            let at = self.prompt_cursor;
            if let Some((i, c)) = buf[at..].char_indices().next() {
                buf.replace_range(at..at + c.len_utf8(), "");
                let _ = i;
            }
        }
    }

    /// A click inside the input row while the prompt is open: place the
    /// caret at the clicked display column (the prompt is one line).
    pub fn prompt_click(&mut self, col: usize) {
        if let Some((_, buf)) = &self.prompt {
            let mut width = 0usize;
            let mut target = buf.len();
...
pub fn is_menu_toggle_key(
    ...
    matches!(code, crossterm::event::KeyCode::F(9))
}
            ...
            Some(Event::Key(key)) => {
                if key.kind == KeyEventKind::Press {
                    ...
                    match key.code {
                        ...
                        KeyCode::Right if app.prompt_active().is_some() => {
                            app.prompt_nudge(1);
                        }
                        KeyCode::Home if app.prompt_active().is_some() => {
                            app.prompt_edge(-1);
                        }
                        KeyCode::End if app.prompt_active().is_some() => {
                            app.prompt_edge(1);
                        }
                        KeyCode::Delete if app.prompt_active().is_some() => {
                            app.prompt_delete();
                        }
                        KeyCode::Esc if app.prompt_active().is_some() => {
                            app.prompt_cancel();
                        }
                        // Menu bar mode (ADR-0017 amendment): F9
                        // opens/closes; arrows move; Enter activates; Esc
                        // closes.
                        KeyCode::F(9) if app.prompt_active().is_none() => {
                            app.menu_toggle();
                        }
                    ...
                    if is_enter && !shift_enter && app.prompt_active().is_some() {
                        ...
                        match app.prompt_submit(&localizer) {
                            Some(failed) => {
                                ...
                                let msg = if matches!(failed, PromptKind::OpenScript) {
    ...
    match event.kind {
        ...
        MouseEventKind::Down(crossterm::event::MouseButton::Left) => {
            ...
            if inside(areas.input, col, row) {
                ...
                if app.prompt_active().is_some() {
                    // The prompt is the input row: the click moves the
                    // path caret (ADR-0017 amendment).
                    app.prompt_click(col);
                    return false;
                }
...
fn draw(frame: &mut ratatui::Frame, app: &mut App, localizer: &Localizer) {
    ...
    if let Some(offset) = app.key_help_offset() {
        ...
        // The "arrows scroll" half of the hint is only true when the
        // list actually overflows (ADR-0039 amendment): a bank of a
        // dozen keys shows just the close hint instead.
        let hint_key = if max > 0 {
            "tui-key-help-hint"
        } else {
            "tui-key-help-hint-fit"
        };
        frame.render_widget(
    ...
    let prompt_mode = app.prompt_active().is_some();
    let caret_line = cursor_line.saturating_sub(input_scroll as usize);
    let at = if prompt_mode {
        app.prompt_caret().min(input_text.len())
    } else {
        app.cursor()
    };
...
= 222",
    ...
    fn open_menu_covers_existing_history_text() {
        ...
        // bar, and is 26 wide × (3 items + borders) tall.
        let popup = Rect {
            x: 1,
            y: 1,
            width: 26,
