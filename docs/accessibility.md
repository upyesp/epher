...
| 1.4.1 Use of color | PASS | No color-only information (result is text; errors are text). The graph's curve palette pairs each color with a distinct dash pattern, and the slider/checkbox row carries text labels (ADR-0020). |
